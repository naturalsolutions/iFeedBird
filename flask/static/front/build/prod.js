...
define('transition-region',['underscore', 'marionette'],
...
define('base/header/lyt-header',['marionette'],
function(Marionette) {
	'use strict';
...
define("i18n", ["jquery"], (function (global) {
    return function () {
        var ret, fn;
        return ret || global.$;
    };
...
define('base/home/lyt-home',['marionette', 'i18n'],
function(Marionette) {
	'use strict';
...
define('lyt-rootview',['marionette', 'transition-region', './base/header/lyt-header', './base/home/lyt-home'],
...
**/
define('router',['jquery', 'marionette', 'backbone'],
...
define('modules/gallery/lyt-gallery',['marionette', 'collections/photos'],
...
define('modules/about/lyt-about',['marionette'],
...
define('modules/contact/lyt-contact',['marionette'],
...
define('modules/details/lyt-details',['marionette',
  'models/photo'],
...
define('modules/species/lyt-species',['marionette',
  'models/espece'],
...
define('modules/focus/lyt-focus',['marionette', 
...
define('app',['marionette', 'backbone', 'lyt-rootview', 'router', 'controller'],
...
'</h5>\r\n\t</div>\r\n\t<br>\r\n\t<div class="species-pictures-gallery">\r\n\t\t<div class="species-picture-1 col-md-6"><img class="img-rounded img-responsive" src="' +
((__t = ( photo1 )) == null ? '' : __t) +
'" alt="picture1"/></div>\r\n\t\t<div class="species-picture-2 col-md-6"><img class="img-rounded img-responsive" src="' +
((__t = ( photo2 )) == null ? '' : __t) +
...
define("templates", ["underscore"], (function (global) {
    return function () {
        var ret, fn;
...
define('translater',['marionette','config','i18n'], function( Marionette,config) {
